...
import { WaiverPanel } from "./_components/WaiverPanel";
import { RedemptionsPanel, type Redemption } from "./_components/RedemptionsPanel";
...
export default function FireHacksPortalPage() {
    ...
    return (
        <div className="min-h-screen px-6 py-10 md:py-16" style={{ fontFamily: 'var(--font-fh-body), sans-serif' }}>
                ...
                {!loading && !errorMessage && participant && (
                    <div className="space-y-5">
                        ...
                        <div className="grid md:grid-cols-2 gap-5">
                            ...
                            <WaiverPanel
                                initialUploadedAt={participant.waiver_uploaded_at}
