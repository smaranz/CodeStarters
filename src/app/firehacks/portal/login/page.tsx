...
export default function FireHacksPortalLoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-6 py-16" style={{ fontFamily: 'var(--font-fh-body), sans-serif' }}>
