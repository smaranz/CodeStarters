...
export default function MemberLoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            window.location.href = "/firehacks/member";
        } catch (err: unknown) {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-6 py-16" style={{ fontFamily: 'var(--font-fh-body), sans-serif' }}>
