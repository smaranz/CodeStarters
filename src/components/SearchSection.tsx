...
export function SearchSection() {
  return (
    <section className="pt-52 md:pt-64 pb-6 md:pb-9 px-6">
      ...
      <motion.p {...fadeUp(0.1)} className="text-muted-foreground text-lg max-w-2xl mx-auto mb-24 text-center">
        The way we discover information has fundamentally shifted. Stay ahead of the curve with curated insights.
      </motion.p>
