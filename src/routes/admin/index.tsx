    ...
    return (
        <div className="space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <Link to="/admin/requests" className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all group">
                ...
                <Link to="/admin/applications" className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all group">
                    <div className="flex justify-between items-start mb-6">
                ...
                <Link to="/admin/team" className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all group">
                    <div className="flex justify-between items-start mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    <Link to="/admin/scanner" className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 hover:bg-brand-50 transition-colors border border-transparent hover:border-brand-100 group">
                    ...
                    <Link to="/admin/applications" className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 hover:bg-amber-50 transition-colors border border-transparent hover:border-amber-100 group">
                    ...
                    <Link to="/admin/team" className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 hover:bg-emerald-50 transition-colors border border-transparent hover:border-emerald-100 group">
